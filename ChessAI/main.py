"""
Driver file (user input and displaying current GameState object)
"""
import pygame as p
import sys
import engine, AI
...
def main():
    ...
    gameOver = False
    playerOne = False #If a human is playing white, then this will be True. If an AI is playing, this will be False
    playerTwo = True #If a human is playing black, then this will be True. If an AI is playing, this will be False
    AIThinking = False 
...
def drawBoard(screen):
    ...
    colors = [p.Color((220,207,186)), p.Color((156, 106, 68))]
